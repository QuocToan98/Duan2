...
<head>
    ...
    <base href="{{asset('public/backend/register')}}/"> 
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="{{url('register')}}" class="signup-image-link">Đăng Ký người dùng mới</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="your_name" placeholder="tên người dùng"/>
                            </div>
                            <div class="form-group">
